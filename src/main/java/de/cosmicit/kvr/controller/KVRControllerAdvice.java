...
import de.cosmicit.kvr.common.ErrorResponse;
import de.cosmicit.kvr.controller.exception.InvalidParameterException;
import de.cosmicit.kvr.controller.exception.LogicalException;
...
@Controller
@ControllerAdvice
public class KVRControllerAdvice extends ResponseEntityExceptionHandler {

    @Value("${kvr-management-service.debug}")
